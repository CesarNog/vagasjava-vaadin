package com.soujava.vagas.views.vagasabertasnomomento;

import java.util.Optional;

import com.soujava.vagas.data.entity.SamplePerson;
import com.soujava.vagas.data.service.SamplePersonService;
...
@PageTitle("Vagas Abertas no momento")
@Route(value = "java_openings/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@RouteAlias(value = "", layout = MainLayout.class)
@Tag("vagas-abertasnomomento-view")
@JsModule("./views/vagasabertasnomomento/vagas-abertasnomomento-view.ts")
@Uses(Icon.class)
public class VagasAbertasnomomentoView extends LitTemplate implements HasStyle, BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "java_openings/%d/edit";
    ...
    public VagasAbertasnomomentoView(@Autowired SamplePersonService samplePersonService) {
        addClassNames("vagas-abertasnomomento-view", "flex", "flex-col", "h-full");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(VagasAbertasnomomentoView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(VagasAbertasnomomentoView.class);
            }
        }
    }
